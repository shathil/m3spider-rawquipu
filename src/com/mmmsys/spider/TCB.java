...
public class TCB
{
    ...
    public int segmentSize; // now shows segment size is 8
    public long mytime; // tcp option1
    public long theirtime;//tcp option 2
    ...
    public Packet templatePack;

    public SocketChannel channel;
    public boolean waitingForNetworkData;
    public SelectionKey selectionKey;

    private static final int MAX_CACHE_SIZE = 1000; // XXX: Is this ideal?
    ...
    public TCB(String ipAndPort, long mySequenceNum, long theirSequenceNum, long myAcknowledgementNum, long theirAcknowledgementNum,
               SocketChannel channel, Packet referencePacket, SocketAddress clientAddress, long initTime)
    {
        ...
        this.templatePack = referencePacket;
        this.clientAddress = clientAddress;
        this.mytime = initTime;
    }
